...
@Getter
@ToString
public class MatchingResponseDTO<E> {
	...
	@Builder(builderMethodName = "f2")
	public MatchingResponseDTO(MatchingRequestDTO matchingRequestDTO, List<E> dtolist, int total) {
		this.page = matchingRequestDTO.getPage();
		this.size = matchingRequestDTO.getSize();
